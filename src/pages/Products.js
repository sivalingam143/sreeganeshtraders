...
const Products = () => {
  ...
  return (
    <>
      <MetaTags
        title="Crackers Price List | Sivakasi Crackers | Best Crackers Shops"
        type="website"
        siteName="diwalicracker.com"
        url="https://diwalicracker.com/"
        keywords="Wholesale Crackers | Sivakasi Crackers | Retails Crackers | Including sparklers, rockets, and more | Celebrate Diwali with affordable and exciting crackers"
