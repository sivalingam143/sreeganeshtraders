                  ...
                  <Col lg='4' md='6' className='paxpad' key={product.id}>
                    <div className='d-flex justify-content-center product-card w-100'>
                        ...
                        <div className='float-left w-100 d-flex'>
                          <div className='float-left left-margin w-50'>
                            {product.discount_lock === 0 ? (
                              <>
                                <span className='net_rate'>₹<span>{Math.round(product.price)}</span></span>
                                <div>
                                  <span className='discount_rate'>₹<span>{product.discount_lock !== null && product.discount_lock === 0 ? (Math.round(product.price - (product.price * categoryItem.discount / 100)).toFixed(2)) : Math.round(product.price)}</span></span>
                                </div>
                              </>
                            ) : null}
                          </div>
                          ...
                          onClick={() => {
                            if (product.qty > 0) {
                              ...
                              addToCart({
                                ...
                                per_price: product.discount_lock !== null && product.discount_lock === 0 ? (Math.round(product.price - (product.price * categoryItem.discount / 100)).toFixed(2)) : Math.round(product.price),
                      ...
                      <div className='pricebox'>
                        <span className='price_rate'>₹<span> {((product.discount_lock !== null && product.discount_lock === 0) ? (Math.round(product.price - (product.price * categoryItem.discount / 100)).toFixed(2)) : Math.round(product.price)) * product.qty.toFixed(2)}</span></span>
                      </div>
                    </div>
                  </Col>
                ))}
